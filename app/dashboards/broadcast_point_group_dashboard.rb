...
class BroadcastPointGroupDashboard < Administrate::BaseDashboard
  ...
  # Overwrite this method to customize how broadcast point groups are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(broadcast_point_group)
  #   "BroadcastPointGroup ##{broadcast_point_group.id}"
  # end
end
