...
class MediaAssetDashboard < Administrate::BaseDashboard
  ...
  ATTRIBUTE_TYPES = {
    ...
    content_kind: LocalizedSelectField.with_options(searchable: false),
    content_type: LocalizedSelectField.with_options(searchable: false),
    visibility: LocalizedSelectField.with_options(searchable: false),
    processing_status: LocalizedSelectField.with_options(searchable: false),
