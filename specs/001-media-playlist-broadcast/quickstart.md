...
- Админка **Avo** (`/avo`) *(исторически; будет заменена на **Administrate**)*: скоуп по `Current.organization` через контекст; без сессии кабинета записи с `organization_id` недоступны (пустые списки).
